...
from pythongame.game_data.decorations import register_ground_decoration, register_statue_decoration
...
def register_all_game_data():
    ...
    register_ground_decoration()
    register_statue_decoration()
