...
def register_skull_sword_item():
    ...
    register_randomized_stat_modifying_item(
        ...
        name="Skull sword",
        stat_modifier_intervals=[StatModifierInterval(HeroStat.DAMAGE, [0.20, 0.21, 0.22, 0.23, 0.24, 0.25]),
                                 StatModifierInterval(HeroStat.LIFE_STEAL, [0.1, 0.11, 0.12, 0.13, 0.14])]
    )
