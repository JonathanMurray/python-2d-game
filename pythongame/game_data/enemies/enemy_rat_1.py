...
class NpcMind(MeleeEnemyNpcMind):
    def __init__(self, global_path_finder: GlobalPathFinder):
        super().__init__(global_path_finder, Millis(2000), 1, 0, Millis(900))
...
def register_rat_1_enemy():
    ...
    register_basic_enemy(
        ...
        npc_data=NpcData.enemy(
            ...
            speed=0.05,
            exp_reward=4,
            enemy_loot_table=LootTableId.LEVEL_1,
            death_sound_id=SoundId.DEATH_RAT),
        mind_constructor=NpcMind,
        spritesheet_path="resources/graphics/brown_rat.png",
        original_sprite_size=(32, 32),
        scaled_sprite_size=(44, 44),
        spritesheet_indices=indices_by_dir,
        sprite_position_relative_to_entity=(-5, -7)
    )
